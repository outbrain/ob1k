...
public class CacheLoaderForTesting implements CacheLoader<String, String>{
  static final String VALUE_FOR = "ValueFor-";
  static final String VALUE_FOR_BULK = "ValueFor-Bulk-";
  static final String MISSING_KEY = "missing-key";
  static final String NULL_KEY = "null-key";
  static final String ERROR_MESSAGE = "missing key";
  static final String TIMEOUT_KEY = "timeOutKey";
  static final String TIMEOUT_MESSAGE = "timeout occurred";
  static final String TEMPORARY_ERROR_MESSAGE = "Load failed temporarily";

  private final AtomicBoolean generateLoaderErrors = new AtomicBoolean(false);

  void setGenerateLoaderErrors(final boolean val) {
