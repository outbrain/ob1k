...
public class ServiceRegistryTest {
  ...
  public void shouldRegisterServiceMethods() {
    registry.register("name", new MyService(), null, null, null, false, Executors.newSingleThreadExecutor());
  ...
  public void shouldNotRegisterNonPublicMethods() {
    registry.register("name", new MyServiceWithNonPublicMethod(), null, null, null, false, Executors.newSingleThreadExecutor());
    final Map<String, Map<HttpRequestMethodType, ServerEndpointView>> endpoints = registry.getRegisteredEndpoints();
  ...
  public void shouldNotRegisterStaticMethods() {
    registry.register("name", new MyServiceWithStaticMethod(), null, null, null, false, Executors.newSingleThreadExecutor());
    final Map<String, Map<HttpRequestMethodType, ServerEndpointView>> endpoints = registry.getRegisteredEndpoints();
    assertEquals("should be none registered endpoints", 0, endpoints.size());
  }
