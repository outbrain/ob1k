...
public abstract class JacksonRequestMarshaller implements RequestMarshaller {
  ...
  public JacksonRequestMarshaller(final JsonFactory factory, final ContentType contentType) {
    this.factory = checkNotNull(factory, "factory may not be null");
    this.contentType = checkNotNull(contentType, "contentType may not be null");
    this.mapper = createObjectMapper(factory);
  ...
  private static ObjectMapper createObjectMapper(final JsonFactory factory) {
