...
public final class CorsConfig {
  ...
  private final Set<String> allowedRequestMethods;
  private final Set<String> allowedRequestHeaders;
  private final boolean allowNullOrigin;
  private final Map<CharSequence, Callable<?>> preflightHeaders;
  private final boolean shortCircuit;
  private final boolean noPreflightHeaders;
   ...
   */
  public Set<String> allowedRequestMethods() {
  ...
  public static class Builder {
     ...
     * CORS 'Access-Control-Request-Method' response header.
     *
     * @param methods the Methods that should be allowed.
     * @return {@link Builder} to support method chaining.
     */
    public Builder allowedRequestMethods(final String... methods) {
